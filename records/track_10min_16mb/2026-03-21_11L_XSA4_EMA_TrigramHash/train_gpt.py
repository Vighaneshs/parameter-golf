"""
Submission: 11L + XSA(last 4) + EMA + TrigramHash + Int5MLP + Int6Attn + SmearGate + BigramHash + OrthoInit + MuonWD
...
2. EMA (Exponential Moving Average, decay=0.997): Maintains a shadow copy of model params on
   ...
   training before quantization. Smoother convergence than SWA's discrete averaging.
...
Architecture: 11 layers (bigram reduced 10240→2048 to fit 11L in 16MB budget).
"""
